...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        myViewPager = (ViewPager) findViewById(R.id.main_page_viewer);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            SendUserToPricavyPolicyActivity();
        }
    ...
    private void SendUserToPricavyPolicyActivity()
    {
        Intent ppIntent = new Intent(MainActivity.this, PrivacyPolicyActivity.class);
